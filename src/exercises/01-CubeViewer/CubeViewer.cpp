...
init()
{
    ...
    m_meshes[1]->scaleObject( Vector3(0.5,0.5,0.5) );
...
createCube()
{
	...
	// setup uniform cube with side length 2 and center of cube being (0,0,0)
	...
	for(int k = 0; k < 4; k++) cubeColors.push_back(Vector3(1,0,0));
	...
	for(int k = 0; k < 4; k++) cubeColors.push_back(Vector3(0,1,0));
	...
	cubeVertices.push_back(Vector3( d, d,-d));
	for(int k = 0; k < 4; k++) cubeNormals.push_back(Vector3(0,0,-1));
	for(int k = 0; k < 4; k++) cubeColors.push_back(Vector3(0,0,1));
	...
	cubeVertices.push_back(Vector3(-d, d, d));
	for(int k = 0; k < 4; k++) cubeNormals.push_back(Vector3(-1,0,0));
	for(int k = 0; k < 4; k++) cubeColors.push_back(Vector3(1,1,0));
	...
	for(int k = 0; k < 4; k++) cubeColors.push_back(Vector3(1,0,1));
	...
	cubeVertices.push_back(Vector3( d,-d, d));
	for(int k = 0; k < 4; k++) cubeNormals.push_back(Vector3(0,-1,0));
	for(int k = 0; k < 4; k++) cubeColors.push_back(Vector3(0,1,1));
